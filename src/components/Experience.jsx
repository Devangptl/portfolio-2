...
const Experience = () => {
  return (
    <div id="experience" className=" md:mt-0 mt-[-130px] flex flex-col justify-center px-7 md:px-[28%] h-screen bg-[#0a192f]">
      ...
      <div className="  ">
        ...
        <div className=" text-[16px] md:text-[20px] pl-9 md:px-14 flex flex-col gap-5 pt-3 text-white ">

           <div className=""  >
            <h1 className="  underline-offset-8 mb-3 font-semibold text-[#abd373] text-[18px]">Intership - 1</h1>
            <p className=" text-[18px] ">Grras Solutions Private Limited | Ahmedabad</p>
            <p className=" text-[#8892b0] ff">Frontend Development</p>
           </div>
           <div className=""  >
            <h1 className="  underline-offset-8 mb-3 font-semibold text-[#abd373] text-[18px]">Intership - 2 ( 6 Months )</h1>
            <p className=" text-[18px] ">Maxgen Technologies Pvt.Ltd | Ahmedabad</p>
            <p className=" text-[#8892b0] ff">ReactJS Development</p>
           </div>
